...
==Last completed step:
* create associations: timesheet:ts_hours | timesheet:ts_cats | user:ts_hours | user:ts_cats
* create timesheet controller / pages_spec

==Next step:
* Working on Timesheet::index
** How to get a list of Timesheet records through TimesheetHours through UserID ??

** TS_Hours::Approved && TS_Cats::Approved should be date/time not boolean (blank == false)
** How do sv_or_admin manage Timesheets?
