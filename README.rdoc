...
==Last completed step:
* application.rb -> class User def has_authority_over
* New User page 'cancel' takes to User's staff page (Users#Show)
* Timesheet#Index::_auth_over_timesheet_table: "create for" button and select_tag

==Next step:
* create timesheet on behalf of direct_report
