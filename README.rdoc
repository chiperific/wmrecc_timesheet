...
5.1 Add new attributes to timesheets_controller
5.2 Replace with a field on the Timesheet page: timeoff_hours
5.4 Add new timeoff fields to timesheet form
5.5 Add a hyperlink to hide/unhide
5.6 Need a way to deny timoff - reviewed but not approved = denied
* Add Weekday model for less assumptive building of _timesheet_form

==Next steps:
5.7 Need views and routes for managing timeoff review and approval
...
* Edit timesheet on behalf of another user, then press cancel - redirects to that user's index view
