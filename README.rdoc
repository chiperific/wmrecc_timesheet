...
==Next step:
* Timesheet#index - Date column is not ordered
* Timesheet#edit and Timesheet#new(with existing TS) doesn't build all weekdays
* Timesheet#Index::_auth_over_timesheet_table: select_tag really should have "fname lname". May need to abandon options_from_collection_for_select method.
