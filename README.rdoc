...
==Last completed step:
* Finish build-out for user form partial

==Next step:
* Edit / new form submission
* Error handling
* User form selection fields not editable?!??!
* view inactive users not working in Firefox or Safari?!??!

==To do:
1. Create partials for edit/new for Department, Categories
...
3. Map out database relations for Timesheet processing
