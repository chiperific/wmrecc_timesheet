...
==Last completed step:
* requests#new -- date is saving
* request RESTful routing
...
==To do:
1. Spec out request_pages and request_spec

2. Add fields to User form (admin or sv view:: annual_time_off, standard_hours, salary_rate, hourly_rate, pay_type{true = salary})
